...
export interface TopNavConfigParams {
  ...
  /** Recomputed when the embeddable reports inspectors so AppMenu (memoized) can enable Inspect. */
...
export const getTopNavConfig = (
  ...
  items.push({
    ...
    disableButton: !inspectorAvailable,
    run: () => {
      openInspector();
    },
    tooltipContent: inspectorAvailable
      ? undefined
      : i18n.translate('visualizations.topNavMenu.openInspectorDisabledButtonTooltip', {
